...
namespace NTW.Moduls.SQL
{
    public class SqlLocator
    {
        ...
        public static string[] GetServers()
        {
            ...
            {
                #if (DEBUG)
                Console.WriteLine("Acquire SQL Servier List Error: " + ex.Message);
                #endif
                txt = string.Empty;
            }
            finally
            ...
            return retval == null ?  new string[] { } : retval;
        }

        public static IEnumerable<string> GetBDNames(SqlConnectionStringBuilder connectionBuilder)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionBuilder.ToString()))
            {
                try
                {
                    ...
                    foreach (DataRow item in tblDatabases.Rows)
                        names.Add(item["database_name"].ToString());
                }
                catch (Exception ex) { }
            }
